...
Wikimedia Foundation runs the 7\oldtextsuperscript{th} most popular
website in the world, and has under 300 employees.  For comparison,
the 6\oldtextsuperscript{th} (Amazon) and 8\oldtextsuperscript{th} (QQ) most popular
...
\vspace{-.8cm}
\begin{center}
\includegraphics[width=.4\textwidth,trim=0 0 0 0, clip=true]{../pictures/Space_Surveillance_Telescope.jpg}
\end{center}
\vspace{-.7cm}
