...
% \vspace{-.8in}
%% {\centering
%% \hspace{.68in}\includegraphics[width=.6\textwidth]{../pictures/moonshine.jpg}\par
%% }
...
\paragraph{\emph{Researching peeragogy.}} A retrospective of sorts, combining perspectives of student, teacher, and researcher.
