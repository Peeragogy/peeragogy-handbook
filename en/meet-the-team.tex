...
\begin{tabular}{lp{2.5in}}
\raisebox{.3in}{\includegraphics[width=1.4in]{../pictures/John.jpg}}
&
...
\raisebox{.3in}{
\vspace{-1em}
\includegraphics[width=1.4in]{../pictures/Charlotte.jpg}
\vspace{-2em}
} &
\raisebox{1in}{\parbox{2.4in}{\textbf{Charlotte Pierce --- USA, MA} \textbf{(Editor, Publisher)} Indie publisher who finds happiness in pushing her limits and seeing them back down.  Augmented her intellect in RheingoldU's Think-Know Tools course, then joined the amazing Peeragogy community, where the plot thickens.
}}
\end{tabular}
