...
\href{http://www.adobe.com/products/adobeconnect/features.html}{Adobe
...
\medskip
\noindent\textbf{Audio and video}: Choose platforms that enable
...
\medskip
\noindent\textbf{Slide pushing:} The best platforms will convert .ppt or .pdf
...
\medskip
\noindent\textbf{Text chat:} As a backchannel, a means of quickly exchanging
...
\medskip
\noindent\textbf{Screen sharing:} The ability of participants to show each other
what is on their screens becomes especially important in peer learning,
where we all have some things to show each other.

\medskip
\noindent\textbf{Web tours:} An alternative to screen-sharing is the ability to
display the same web page(s) to all participants by entering URLs.

\medskip
\noindent\textbf{Interactive whiteboards}: A shared space that enables
