...
\begin{quote}
\includegraphics{images/interface.png} \textbf{Interface}: the project
shows people how they can use it.\\
\includegraphics{images/familiar.png} \textbf{Familiarity}: the
leader/follower dichotomy is easy to understand.\\
\includegraphics{images/equity.png} \textbf{Equity}: peeragogy aims for
fairness.
\end{quote}
