...
{\small Bryan Alexander, Paul Allison, Elisa Armendariz,} \\
...
{\small Roland Legrand, Christopher Tillman Neal, Ted Newcomb,} \\
{\small Stephanie Parker, Miguel Angel Pérez Alvarez, David Preston,} \\
{\small Stephanie Schipper, Peter Taylor, Fabrizio Terzi,} \\
{\small and Geoff Walker}
}
\date{\today\ (version 3.0$\alpha_2$)}
\maketitle
\thispagestyle{empty}
...
Charlie and Charlotte, and all, please say something here, if we want
a preface.  Should not be redundant with what's in the Introduction.
(And please check the 1st page of the introduction since it's probably
a bit wonky.)
\clearpage
 %%%%%%%%%%%%%%%%%%%%  %%%%%%%%%%%%%%%%%%%%  %%%%%%%%%%%%%%%%%%%%
