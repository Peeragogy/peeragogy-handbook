...
{\small Jay Cross, Karen Beukema Einstein, Julian Elve,}\\
...
{\small Dorotea Mar, Christopher Tillman Neal, Ted Newcomb,} \\
{\small Stephanie Parker, Miguel \'Angel P\'erez \'Alvarez, David Preston,} \\
{\small Paola Ricaurte, Stephanie Schipper, Lisa Snow MacDonald,} \\
{\small Peter Taylor, Fabrizio Terzi, and Geoff Walker}
}
\date{\today\ (version 3.0$\beta_6$)}
\maketitle
\thispagestyle{empty}
...
pagecommand={\pagestyle{companion}}]{peeragogy-workbook-insert-merge-text.pdf}
