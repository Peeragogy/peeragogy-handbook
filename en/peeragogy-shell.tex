...
{\small John Graves, Gigi Johnson, Anna Keune,} \\
{\small Kyle Larson, Roland Legrand, Amanda Lyons, } \\
{\small Christopher Neal, Ted Newcomb, Stephanie Parker,} \\
{\small Charlotte Pierce, David Preston, Howard Rheingold,} \\
{\small Paola Ricaurte, Stephanie Schipper, Fabrizio Terzi,}\\
{\small and Geoff Walker}
}
\date{\today\ (version 1.3$\alpha$)}
\maketitle
\thispagestyle{empty}
