...
% the offset in the \includepdf command to offset=5mm 0mm vs offset=0mm 0mm for the ebook version
...
\newpage
%\cftaddtitleline{toc}{chapter}{Workbook}{\thepage}
%\addcontentsline{toc}{section}{~\protect\vspace{-1.5cm}}
\addtocontents{toc}{%
 \protect\vspace{-.5cm}%
}
\includepdf[addtotoc={1,chapter,0,Workbook,chap:workbook},page={1-},offset=0mm 0mm,pagecommand={\pagestyle{companion}}]{peeragogy-workbook-insert.pdf}
