...
### ![image](http://metameso.org/~joe/OpenBook-2-2.jpg)
...
### ![image](http://metameso.org/~joe/OpenBook-2-3.jpg)
...
### ![image](http://metameso.org/~joe/OpenBook-2-4.jpg)
...
![image](http://metameso.org/~joe/OpenBook-3.jpg)
...
-   Use Heading 2 and Heading 3 tags to mark up sections, not **bold**
    ...
    **check** that the markup *is actually correct*. It should exactly
    surround the words that you're marking up -- `<em>like this</em>` --
...
[![image](http://peeragogy.org/wp-content/uploads/2012/04/Bryan.jpg "Bryan")](http://peeragogy.org/wp-content/uploads/2012/04/Bryan.jpg)**Bryan
