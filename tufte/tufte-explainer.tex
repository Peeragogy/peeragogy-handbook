...
\linebreak\Verb|\subsection| and smaller headings.
...
The following headings are not supported: \doccmd{subsection} and \doccmd{subparagraph}.
...
\docmsg{Error: \doccmd{subsection} is undefined by this class.}{%
The \doccmd{subsection} command is not defined in the \TL document classes.
If you'd like to use the \doccmd{subsection} command, you'll need to
