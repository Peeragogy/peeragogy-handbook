...
%       SmallCapsFeatures = { Color=FFFFFF,   RawFeature={+smcp,+hlig,+dlig}} },  
     ...
     BoldItalicFont={Linux Biolinum},   
     BoldItalicFeatures={ Color = FFFFFF, %
      SmallCapsFont={Linux Libertine Capitals Bold},  %
      SmallCapsFeatures = { Color=FFFFFF,RawFeature={+smcp,+hlig,+dlig}}} ]{Linux Libertine} 
...
%\phantomsection
%\addcontentsline{toc}{chapter}{Web Pages Cited in This Book}
